...
function scene:create( event )
	...
	lobbyText = display.newText("大廳",0,0,native.systemFontBold,80)
	lobbyText.x = display.contentWidth/8.3
	lobbyText.y = display.contentHeight/3.5

	sceneGroup:insert( lobbyText )
